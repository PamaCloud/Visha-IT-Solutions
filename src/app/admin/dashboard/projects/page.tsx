    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-secondary flex items-center gap-2">
          <FolderGit2 size={24} className="text-primary" /> Projects Portfolio
        </h1>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-surface text-secondary-light border-b border-gray-100">
              ...
              <th className="p-4 font-semibold hidden md:table-cell">Client</th>
            ...
            {projects.length > 0 ? (
              projects.map((project: any) => (
                <tr key={project._id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-4 text-secondary-light hidden md:table-cell">{project.clientName}</td>
